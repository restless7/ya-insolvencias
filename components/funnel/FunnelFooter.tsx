            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="font-body text-white/40 text-xs max-w-2xl leading-relaxed">
                        Regulados por la <strong className="text-white/60">Ley 2445 de 2025</strong> y por el Código General del Proceso. Ya Insolvencias no es un banco ni entidad financiera. Presta servicios de asesoría jurídica y representacion en procesos de insolvencia de persona natural.
                    </p>
